...
public class ZookeeperWatcherTest {
    private ZookeeperWatcher crud;

    @Before
    public void setUp() throws Exception {
        crud = new ZookeeperWatcher();
    ...
    public void createEphemeral() throws KeeperException, InterruptedException {
        ...
        String result = crud.getData(path, true);
    ...
    public void setData() throws KeeperException, InterruptedException {
        ...
        String data = crud.getData(path, true);
        Assert.assertEquals(data, "Persistent");
    }

    @Test
    public void exists() throws KeeperException, InterruptedException {
        Stat exists = crud.exists("/test", true);
